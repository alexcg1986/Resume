...
export const timelineData: Array<ITimeline> = [
    {
        ...
        stack: "Python, C#, Lua, Typescript, React, Yaml, Docker, Kubernetes, FastApi, SQLAlchemy, pytest, Revit SDK, Ant Design, Jest, Playwright, Git, PostgreSQL, MySQL, MariaDB, Neovim, Visual Studio, Lazygit, Lazydocker, K9s, kubectl, Windows Terminal, Powershell, DBeaver...",
        tasks: [
