...
export const timelineData: Array<ITimeline> = [
    {
        ...
        stack: "Python, C#, Lua, Typescript, React, Yaml, Docker, Kubernetes, Pydantic, FastApi, SQLAlchemy, Alembic, Swagger, Revit SDK, pyRevit, Python.Net, IronPython, Ant Design, BC3, Git, MariaDB, Neovim, Visual Studio, Lazygit, Lazydocker, K9s, kubectl, Windows Terminal, Powershell, DBeaver...",
        tasks: [
